"""
Django settings for clients_data project.
...
SECRET_KEY = 'django-insecure-dhq8q-rj$vd39h^hh4_0*%5p8ul@l2z8m)ghr$w5bz2*y7upe0'
...
WSGI_APPLICATION = 'clients_data.wsgi.application'
